...
This module provides 2 active approaches to generate dynamic views:
1. Traditional ML (XGBoost) - supervised learning
2. LLM-based (GPT-4, Claude) - combines quantitative + qualitative data
"""
...
class TraditionalMLViewGenerator:
    ...
    ----------------------------------------
    Uses XGBoost to predict future returns.
    ...
    def train(self, prices: pd.DataFrame, verbose: bool = True):
        ...
        try:
            ...
            raise ImportError(
                "XGBoost is required for TraditionalMLViewGenerator. Install with: pip install xgboost"
            ) from e
    ...
    def load(self, filepath: Union[str, Path]):
        ...
        if save_dict.get("model_type") != "xgboost":
            raise ValueError(
                "Only XGBoost model artifacts are supported. Please retrain with view_llm/train_ml_models.py --method xgboost"
            )
...
#     """
#     Option 2: LLM-based View Generator (GPT-4, Claude)
#     ---------------------------------------------------
...
#         Weights for (traditional_ml, llm)
...
#     # ====================== OPTION 1: Traditional ML ======================
#     print("\n" + "=" * 70)
#     print("OPTION 1: Traditional ML (XGBoost)")
#     print("=" * 70)
...
#     # ====================== OPTION 2: LLM ======================
#     print("\n" + "=" * 70)
#     print("OPTION 2: LLM-based (GPT-4 / Claude)")
#     print("=" * 70)
...
#     # ====================== COMBINE VIEWS ======================
#     print("\n" + "=" * 70)
#     print("COMBINING VIEWS FROM ACTIVE OPTIONS")
#     print("=" * 70)
